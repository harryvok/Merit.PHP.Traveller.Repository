...
<div style="float:left;">
              ...
              <div style="float:left;">Request User Defined Fields (<?php echo $count_udf; ?>)</div>
                  ...
                  if($udf->udf_active_ind == "Y" && $udf->udf_action_id == 0){
					...
					if($udf->udf_type == "L"){
                      ...
                      ?>
                          ...
                          <div class="float-left">
                              <input type="text" name="udf_<?php echo $udf->udf_name; ?>" id="udf_<?php echo $udf->udf_order; ?>" class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?> digits" value="<?php if(isset($udf->udf_data)) echo $udf->udf_data; ?>" size="5" maxlength="<?php if($udf->udf_fld_size > 0){ echo $udf->udf_fld_size; } ?>">
                          </div>
                      <?php
                      }
                      ...
                      ?>
                          ...
                          <div class="float-left">
                              ...
                              <strong>Upload New:</strong> <input type="file" name="udf_<?php echo $udf->udf_name; ?>" id="udf_<?php echo $udf->udf_order; ?>" class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" >
                          </div>
                      <?php
                      }
          ...
          if($udf->udf_active_ind == "Y" && $udf->udf_action_id == 0){
              ...
              if($udf->udf_type == "L"){
				  ...
				  ?>
					  ...
					  <div class="float-left">
							<?php if(isset($udf->udf_data)){ if(stristr(str_ireplace("\\", "/", $udf->udf_data), ATTACHMENT_FOLDER)){ ?><a id="<?php echo str_ireplace("\\", "/", $udf->udf_data); ?>" class="ViewFile">View Attachment</a> <?php } else{ echo $udf->udf_data; }
                                  }  ?><br />
						  <strong>Upload New:</strong> <input type="file" name="udf_<?php echo $udf->udf_name; ?>" id="udf_<?php echo $udf->udf_order; ?>" class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" >
					  </div>
				  <?php
                ...
                elseif($udf->udf_type == "I"){
                    $i=$i+1;
                      ?>
                          ...
                          <div class="float-left">
                              <input type="text" name="udf_<?php echo $udf->udf_name; ?>" id="act_udf_<?php echo $udf->udf_order; ?>" class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?> digits" value="<?php if(isset($udf->udf_data)) echo $udf->udf_data; ?>" size="5" maxlength="<?php if($udf->udf_fld_size > 0){ echo $udf->udf_fld_size; } ?>">
                          </div>
                      <?php
                }
                elseif($udf->udf_type == "A"){
                ...
                elseif($udf->udf_type == "D"){
                    $i=$i+1;
                      ?>
                          ...
                          <div class="float-left">
                              <input type="text" name="udf_<?php echo $udf->udf_name; ?>" id="act_udf_<?php echo $udf->udf_order; ?>" class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" value="<?php if(isset($udf->udf_data)) echo date("h:i A", strtotime($udf->udf_data)); ?>" size="5" maxlength="10"  >
                          </div>
                      <?php	
                }
                elseif($udf->udf_type == "Y"){
                ...
                elseif($udf->udf_type == "V"){
                    ...
                    if(isset($udfdata[0]) && !isset($udfdata[1])){
                        ...
                        $udfdata[0] = substr($udfdata[0],0,10);
                              ...
                              ?>
                           Date: <input type="text" name="udf_<?php echo $udf->udf_name; ?>_date" id="act_udf_<?php echo $udf->udf_name; ?>_date" class="text_udf_small <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" value="<?php if(isset($udfdata[0])) echo $udfdata[0]; ?>" size="5" maxlength="10" >
						Time: <input type="text" name="udf_<?php echo $udf->udf_name; ?>_time" id="act_udf_<?php echo $udf->udf_name; ?>_time" class="text_udf_small <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" value="<?php if(isset($udfdata[1]) && strlen($udfdata[1]) > 0) echo date("h:i A", strtotime($udfdata[1])); ?>" size="5" maxlength="10">
                    ...
                    $i=$i+1;
                      ?>
						  ...
						  <div class="float-left">
							  ...
							  <strong>Upload New:</strong> <input type="file" name="udf_<?php echo $udf->udf_name; ?>" id="act_udf_<?php echo $udf->udf_order; ?>" class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" >
						  </div>
					  <?php
                }
                elseif($udf->udf_type == "B"){
