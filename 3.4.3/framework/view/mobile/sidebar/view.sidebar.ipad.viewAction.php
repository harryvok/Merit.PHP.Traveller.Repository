<ul data-role="listview" data-inset="true" data-theme="c" data-dividertheme="f">
				            ...
				            <?php if($_SESSION['roleSecurity']->maint_udf == "Y" && $GLOBALS['result'] > 1){ ?><li><a href="index.php?page=view-action&id=<?php echo $_GET['id']; ?>&d=udfs">User Defined Fields</a></li><?php } ?>				           <?php if($_SESSION['roleSecurity']->maint_comment == "Y" || $_SESSION['roleSecurity']->maint_attachment == "Y"){ ?><li><a href="index.php?page=view-action&id=<?php echo $_GET['id']; ?>&d=ca">Comments and Attachments</a></li><?php } ?>
