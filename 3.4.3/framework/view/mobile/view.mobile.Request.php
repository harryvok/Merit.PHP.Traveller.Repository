...
?>
  ...
  <ul class="no-ellipses" class="no-ellipses" data-role="listview" data-inset="true" data-divider-theme="d">
      ...
      <li>
          <p><strong>Completed Date:</strong> <?php if($GLOBALS['result']->status != "Open"){ if(strlen($GLOBALS['result']->status_datetime) > 0){ echo date('d/m/Y h:i A',strtotime(str_ireplace("00:00:00.000", "", $GLOBALS['result']->status_datetime))); } } ?></p>
      </li>
      <li>
