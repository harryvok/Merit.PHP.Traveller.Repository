            ...
            <div>
                <div class="column r60">
                    ...
                    <div class="column r25">
                        ...
                        <input type="button" id="workflowSRF" value="Show Workflow" disabled="disabled" style="margin-top: -27px; margin-left: 260px; position: absolute;"/>
            ...
            <div>
                <div class="column r50">
                    ...
                    <div class="column r25">
                        ...
                        <input class="text" name='lno' onChange="changeLocationType(); GetAddressDetails();" id="lno" maxlength='15' value='<?php if(isset($_SESSION['rem_lno'])){ echo $_SESSION['rem_lno']; } ?>'>
                    </div>
                    
                    <div class="column r25">
                        <label for="lstreet">Street Name<span class="location_address_label mandLabel" style="color: red; display:none;">*</span></label>
                        <input class="text checkNone" name='lstreet' onChange="changeLocationType()" id="lstreet" data-mand="location_address"  maxlength='100' value='<?php if(isset($_SESSION['rem_lstreet'])){ echo $_SESSION['rem_lstreet']; } ?>'>
                    </div>
                    <div class="column r25">
                        <label for="ltype">Street Type<span class="location_address_label mandLabel" style="color: red; display:none;">*</span></label>
                        <input class="text checkNone" name='ltype' onChange="changeLocationType()" id="ltype" data-mand="location_address" disabled="disabled" maxlength='100' value='<?php if(isset($_SESSION['rem_ltype'])){ echo $_SESSION['rem_ltype']; } ?>'>
                    </div>
                    <div class="float-left">
                        <div class="column r25">
                            <label for="lsuburb">Suburb<span class="location_address_label mandLabel" style="color: red; display:none;">*</span></label>
                            <input class="text checkNone" name='lsuburb' onChange="changeLocationType()" id="lsuburb" data-mand="location_address"  disabled="disabled" maxlength='100' value='<?php if(isset($_SESSION['rem_lsuburb'])){ echo $_SESSION['rem_lsuburb']; } ?>'>
                        </div>
                        <div class="column r25">
                        ...
                        <div class="column r100">
                            ...
                            <input type="button" value="Addr Summary" id="AddrSummary" onclick="" disabled="disabled" />
