...
$success_array = array(
    ...
    'success_action_resubmit' => 'The action with the action ID of #<a href="index.php?page=view-action&id='.$_SESSION['action_id'].'">'.$_SESSION['action_id'].'</a> has been resubmitted.',
