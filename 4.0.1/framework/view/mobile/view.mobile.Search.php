                ...
                if($result_search->result_type == "Request"){
                    ...
                    <li>
                        <a data-transition="slide" href="index.php?page=view-request&id=<?php echo $result_search->key_id; ?>&ref_page=Search">
                         <b><?php echo $result_search->result_type; ?>:</b> <?php echo $result_search->key_id; ?>  - <?php echo base64_decode($result_search->description); ?><br />
                        </a>
                    </li>
                    <?php
                }
                ...
                elseif($result_search->result_type == "Officer"){
                    ...
                    <li>
                        <a data-transition="slide" href="index.php?page=view-officer&id=<?php echo $result_search->key_id; ?>&ref_page=Search">
                         <b><?php echo $result_search->result_type; ?>:</b> <?php echo base64_decode($result_search->description); ?><br />
                        </a>
                    </li>
                    <?php
                }
                    ...
                    <li>
                        ...
                        <b><?php echo $result_search->result_type; ?>:</b> <?php echo $result_search->key_id; ?> -  <?php echo base64_decode($result_search->description); ?> 
                        </a>
                    </li>
                    <?php
                }
