...
<div data-role="content">
    <p>
        <ul data-role="listview"  data-inset="true">
            ...
            <p><b>Number to Allocate: </b> <input type="text" name="alloc_no" id="alloc_no" value="<?php if ($GLOBALS['result']->available_count > 0) echo 1; else echo 0; ?>" disabled="disabled" style="font-weight:700;"/> <?php echo "( ".$GLOBALS['result']->available_text; ." )" ?>  </p> 
