 ...
 <input id="submit" class="button left" type='submit' value='Submit' />
  ...
  if(count($GLOBALS['result']->request_remark_details) > 1){
      ...
      foreach($GLOBALS['result']->request_remark_details as $result_at_get){
              ...
              <?php if($_SESSION['roleSecurity']->delete_attachment == "Y"){ ?>
                <a data-role="button" href="#" id="DeleteAttachment" data-action="deleteAttachment" class="deleteAttachment"><img src="images/delete-icon.png" width="16" height="16" /> Delete</a>
             <?php } ?>
              <?php
  ...
  elseif(count($GLOBALS['result']->request_remark_details) == 1){
      $result_at_get = $GLOBALS['result']->request_remark_details;
            ...
            <?php if($_SESSION['roleSecurity']->delete_attachment == "Y"){ ?>
                <a data-role="button" href="#" class="deleteAttachment" data-action="deleteAttachment" class="deleteAttachment"><img src="images/delete-icon.png" width="16" height="16" /> Delete</a>
             <?php } ?>
              <?php
