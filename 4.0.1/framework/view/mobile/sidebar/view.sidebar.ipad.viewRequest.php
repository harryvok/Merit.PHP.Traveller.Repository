<ul data-role="listview" data-inset="true" data-theme="c" data-dividertheme="f">
    ...
    <?php if($GLOBALS['count_only'] == "N" && $_SESSION['roleSecurity']->view_request_show_actions == "Y"){ ?><li><a href="index.php?page=view-request&id=<?php echo $_GET['id']; ?>&d=actions" >Actions</a></li><?php } ?>
