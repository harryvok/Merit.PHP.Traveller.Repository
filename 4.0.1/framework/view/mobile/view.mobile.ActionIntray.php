    ...
    foreach($GLOBALS['result']->action_intray_details as $action_details){
        ...
        elseif($action_details->status_code == "SUSPENDED"){
            ...
            <?php echo $action_details->assign_name; ?> </p>
                ...
                <p><b>Issue: </b><?php if(strlen($action_details->request_description) > 0){ echo base64_decode($action_details->request_description); } else { echo ""; } ?></p>
                ...
                <?php if( $_SESSION['roleSecurity']->hide_customer_details == "N"){?><p><b>Customer Name:</b> <?php if(isset($action_details->customer_given_name)){ if($action_details->customer_given_name != "Used") echo $action_details->customer_given_name; } if(isset($action_details->customer_surname)){ if($action_details->customer_surname != "Not") echo " " .$action_details->customer_surname; } ?></p><?php } ?>
