 <ul class="subButtons">
    <li class="sm">Options
        <ul>
            ...
            <?php if($GLOBALS['count_only'] == "N"){ ?><li onclick="self.location.href='index.php?page=view-request&id=<?php echo $_GET['id']; ?>&d=actions'" <?php if(isset($_GET['d']) && $_GET['d'] == "actions"){ ?>class="act"<?php } ?>>Actions</li><?php } ?>
    ...
    <?php if($GLOBALS['count_only'] == "N"){ ?><li class="la" onclick="self.location.href='index.php?page=view-request&id=<?php echo $_GET['id']; ?>&d=actions'" <?php if(isset($_GET['d']) && $_GET['d'] == "actions"){ ?>class="act"<?php } ?>>Actions</li><?php } ?>
