...
<ul class="subButtons">
    <li class="sm">Options
        <ul>
            ...
            <?php if($_SESSION['roleSecurity']->view_notifications == "Y"){ ?><li onclick="self.location.href='index.php?page=view-request&id=<?php echo $_GET['id']; ?>&d=notifications'" <?php if(isset($_GET['d']) && $_GET['d'] == "notifications"){ ?>class="act"<?php } ?>>Notifications</li><?php }?>
    ...
    <?php if($_SESSION['roleSecurity']->view_notifications == "Y"){ ?><li class="la" onclick="self.location.href='index.php?page=view-request&id=<?php echo $_GET['id']; ?>&d=notifications'" <?php if(isset($_GET['d']) && $_GET['d'] == "notifications"){ ?>class="act"<?php } ?>>Notifications</li><?php }?>
