...
<ul class="subButtons">
      ...
      <li onclick="self.location.href='index.php?page=view-officer&id=<?php echo $_GET['id']; ?>&d=req'" <?php if(isset($_GET['d']) && $_GET['d'] == "requests"){ ?>class="req"<?php } ?>>Requests  (<?php echo $GLOBALS['requestCount']; ?>)</li>
</ul>
