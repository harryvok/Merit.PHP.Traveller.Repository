        ...
        <table id="requestActionsTable" class=" sortable" title="" cellspacing="0">
            ...
            <tbody>
                ...
                <tr class="<?php echo $class; ?>" onClick="divFunction('<?php echo $change; ?>','<?php echo $datevalue; ?>','<?php echo $timevalue; ?>')" title="">
                    ...
                    <td><?php if(strlen($result_a_ar->due_time) > 0 && $result_a_ar->due_time != "1970-01-01T00:00:00"){ echo date('d/m/Y h:i A',strtotime($result_a_ar->due_time)); }  ?><?php if($GLOBALS['result']['action']->change_due_date != "N" && $result_a_ar->status_code == "OPEN"){ ?><a class="edit" id="EditDateDetails" style="color:white"><img src="images/modify-icon.png"></a><?php } ?></td>
                ...
                <tr class="dark" onClick="divFunction('<?php echo $change; ?>','<?php echo $datevalue; ?>','<?php echo $timevalue; ?>')" title="">
                    ...
                    <td><?php if(strlen($GLOBALS['result']['actions']->request_actions_det->request_actions_details->due_time) > 0 && $GLOBALS['result']['actions']->request_actions_det->request_actions_details->due_time != "1970-01-01T00:00:00"){ echo date('d/m/Y h:i A',strtotime($GLOBALS['result']['actions']->request_actions_det->request_actions_details->due_time)); }  ?><?php if($GLOBALS['result']['action']->change_due_date != "N" && $result_a_ar->status_code == "OPEN"){ ?><a class="edit" id="EditDateDetails" style="color:white"><img src="images/modify-icon.png"></a><?php } ?></td>
