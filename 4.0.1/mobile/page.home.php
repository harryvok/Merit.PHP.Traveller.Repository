        ...
        <div id="contentBox">
            ...
            <div data-role="page" data-dom-cache="true">
                <div data-role="header" data-tap-toggle="false" data-position="fixed">
                    <h1>
                        <img alt="list" src="images/favicon.png" width="16" height="16" />
                        Merit Traveller</h1>
                </div>
                <div data-role="content" id="contentBox">
                    <div class="content-secondary">
                        <ul data-role="listview" data-inset="true" data-theme="c" data-dividertheme="f">
                            ...
                            <?php if($_SESSION['roleSecurity']->maint_new_request == "Y") { ?>
                    ...
                    <div class="content-primary">
                        ...
                        <div class="iphone">
                            <div data-role="controlgroup">
                                ...
                                <?php if(defined('CHANGE_PASSWORD') && CHANGE_PASSWORD == 1 && $_SESSION['roleSecurity']->allow_cpwd == "Y"){ ?><li><a data-role="button" data-iconpos="left" data-icon="modify" href="index.php?page=changePassword" data-transition="slide">Change Password</a><?php }?>
