    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('input[name=availInd]').on("change", function () {
                ...
                if (val == "Y") { $("#availFromDate").prop("disabled", true); $("#availToDate").prop('disabled', true); $("#availFromTime").prop("disabled", true); $("#availToTime").prop('disabled', true); $("#availFromDate").val(""); $("#availFromTime").val(""); $("#availToDate").val(""); $("#availToTime").val(""); }
                if (val == "N") {
    ...
    <div class="column r50">
        ...
        <div class="summaryContainer">
            ...
            <div>
                ...
                <!-- 
                <label>Case Intray</label>
                <select name="caseIntray">
        ...
        <div class="summaryContainer">
            ...
            <div>
                ...
                <input name='repeat' maxlength='15' class='text'><br>
