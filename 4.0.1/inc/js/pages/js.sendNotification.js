$(document).ready(function () {
    ...
    $("#emailAdd").click(function () {
        ...
        //$("#listEmail").html($("#listEmail").html() + "<span id='emailText" + email + "List'><span id='emailText" + email + "NameLab'>Name:</span><input id='emailText" + email + "Name' type='text'  value='' /><span id='emailText" + email + "EmailLab'>Email:</span><input id='emailText" + email + "Email' type='text' value='' /><input id='emailText" + email + "Type' type='hidden' value='' /><input type='button' value='Add' id='emailText" + email + "Add' /> <img data-delete='emailText" + email + "List' src='images/delete-icon.png'><br /></span>");
        ...
        $("#emailText" + email + "Add").click(function () {
            if ($("#emailText" + email + "Name").length > 0 && $("#emailText" + email + "Email").length > 0 && validateEmail($("#emailText" + email + "Email").val())) {
               ...
               // $("#emailText" + email + "Email").val(emailaddress);
    ...
    $("#emailOfficerAdd").click(function () {
        $("#emailAdd").hide();
        $("#emailOfficerAdd").hide();
        $("#listEmail").html($("#listEmail").html() + "<span id='emailText" + email + "List'><span id='emailText" + email + "NameLab'>Officer:</span> <input id='emailText" + email + "Officer' type='text'  value='' /><input id='emailText" + email + "OfficerCode' type='hidden'  value='' /><input id='emailText" + email + "Name' type='hidden'  value='' /><input id='emailText" + email + "Email' type='hidden'  value='' /> <img data-delete='emailText" + email + "List' src='images/delete-icon.png'><br /></span>");
