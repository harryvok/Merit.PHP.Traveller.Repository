...
$(document).ready(function () {
    ...
    function facilityResponse(event, ui) {
        ...
        if (typeof ui.content != "undefined" && ui.content.length === 1) {
            ...
            facility_description = ui.content[0].officer_name;
        }
        ...
        if (label.length > 0) {
            ...
            $("#officerName").val(officer_name);
            $("#facilityDesc").val(facility_description);
    ...
    $("#lstreet").on(eventName, function (event) {
        if ($("#facilityInput").val().length > 0) {
            ...
            $("#lstreet").attr("readonly", false).val("").autocomplete("search", $("#lstreet").val());
        }
    });
