...
<?php if($_SESSION['roleSecurity']->allow_request == "Y") { ?><a class="header-nav" href="index.php?page=requests">REQUESTS</a><?php } ?>
    ...
    <script type="text/javascript">
    	...
    	<div class="column half"><div class="profImage"><img src="images/pc/prof.gif" width="20"></div><div class="welcome"><h3><b><?php if(isset($_SESSION['given_name'])) echo $_SESSION['given_name']; ?></b></h3></div><div class="bottomButtons"> <?php if(defined('CHANGE_PASSWORD') && CHANGE_PASSWORD == 1 && $_SESSION['roleSecurity']->allow_cpwd == "Y"){ ?><a href="index.php?page=changePassword">CHANGE PASSWORD</a><?php } ?><a href="index.php?page=modifySettings">MODIFY SETTINGS</a></div></div>
        <div class="column half"><div class="version"><h3>v<?php if(isset($version)){ echo $version; } ?> &copy; Merit 2013</h3></div><div class="searchBar"> <input type="text" placeholder="Search..." id="searchInput"></div></div>
    </div>
           <!--[if IE 8]>
                ...
                <div id="content">
                    ...
                    <h1 class="page"><?php echo $realNameArray[$page]; ?></h1>
                    <?php if($d != null){ ?><h2 class="subPage"><?php echo $realNameArray[$d]; ?></h2><?php } ?>
