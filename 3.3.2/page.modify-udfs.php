...
if(isset($_GET['ref_page'])){ $ref_page = strip_tags($_GET['ref_page']); }
...
<head>
    ...
    <title><?php echo SITE_TITLE; ?> - Modify User Defined Fields</title>
</head>
<body>
    <div id="topbar">
        <div id="title">
        Modify UDFs</div>
        <div id="leftnav">
		<a href="index.php?page=<?php echo $ref_page; ?>&id=<?php if(isset($act_id)){ echo $act_id;} else {echo $req_id;} ?>">Back</a></div>
        </div>
    </div>
    <div id="wrapper">
        <div id="scroller">
