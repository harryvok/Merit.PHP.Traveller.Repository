...
if($mobile_browser >0){
	...
	if(isset($_SESSION['modify_auth']) && $_SESSION['modify_auth'] == 1){
        ...
        <form method="post" id="setup" action="process.setup.php">
              ...
              <label  for="council_name">Lookup Enabled?<span style="color:red;">*</span></label><br />
              Yes <input type="radio" class="radio required" name="lookup" value="1"  <?php if(defined('LOOKUP_ENABLED') && LOOKUP_ENABLED == '1') echo 'checked="checked"'; ?>> 
              No <input type="radio" class="radio required" name="lookup" value="0" <?php if(defined('LOOKUP_ENABLED') && LOOKUP_ENABLED == '0' || !defined('LOOKUP_ENABLED') ) echo 'checked="checked"';  ?>> <br />
              <span class="small">(Whether or not name and address lookup is enabled.)</span><br />
              <label  for="council_name">Allow Change Password?<span style="color:red;">*</span></label><br />
              ...
              <label  for="council_name">Links In New Window?<span style="color:red;">*</span></label><br />
              ...
              <span class="small">(If you wish to embed Intramaps into Traveller please state it's URL without the Lot and Property Number on the end of the URL. Keep mapkey=.)</span><p>&nbsp;</p>
