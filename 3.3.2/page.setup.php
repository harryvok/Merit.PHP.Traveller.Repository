  ...
  <div id="content">
      <div class="pad-fix">
          ...
          <form method="post" id="setup" action="process.setup.php">
              ...
              Yes <input type="radio" class="radio required" name="lookup" value="1"  <?php if(isset($_SESSION['rem_lookup']) && $_SESSION['rem_lookup'] == '1') echo 'checked="checked"'; ?>> 
              No <input type="radio" class="radio required" name="lookup" value="0" <?php if(isset($_SESSION['rem_lookup']) && $_SESSION['rem_lookup'] == '0') echo 'checked="checked"';  ?>> <br />
