...
?>
    <div class="view-request">
      ...
      <span class="request-column-title">Date Input</span>
        <div class="request-column"><?php if(strlen($GLOBALS['result']['action']->assign_datetime) > 0){ echo date('d/m/Y',strtotime(str_ireplace("00:00:00.000", "", $GLOBALS['result']['action']->assign_datetime))); }?></div>
        <span class="request-column-title">Action Officer</span>
            <div class="request-column"><?php if(isset($GLOBALS['result']['action']->action_officer_name)){ echo $GLOBALS['result']['action']->action_officer_name; } ?></div>
      <span class="request-column-title">Priority</span>
        <div class="request-column"><?php echo $GLOBALS['result']['action']->priority; ?></div>
      
      </div>
<div class="column quarter">
<span class="request-column-title">Due Date</span>
        <div class="request-column"><?php if(strlen($GLOBALS['result']['action']->due_datetime) > 0 && $GLOBALS['result']['action']->due_datetime != "1970-01-01T00:00:00"){ echo date('d/m/Y h:i A',strtotime(str_ireplace("00:00:00.000", "", $GLOBALS['result']['action']->due_datetime))); }?>
          
        </div>
         <span class="request-column-title">Input Officer</span>
            <div class="request-column"><?php if(isset($GLOBALS['result']['request']->input_by_name)){ echo $GLOBALS['result']['request']->input_by_name; } ?></div>
<span class="request-column-title">Reference No.</span>
        <div class="request-column"><?php if(isset($GLOBALS['result']['request']->refer_no)){ echo $GLOBALS['result']['request']->refer_no; } ?></div>
                  </div>
<div class="column quarter">
      <span class="request-column-title">Completed Date</span>
        <div class="request-column"><?php if($GLOBALS['result']['action']->finalised_ind == "Y"){echo date('d/m/Y h:i A',strtotime($GLOBALS['result']['action']->outcome_datetime)); } ?></div>
        <span class="request-column-title">Completed Outcome</span>
            <div class="request-column"><?php if(isset($GLOBALS['result']['action']->outcome_name)){ echo $GLOBALS['result']['action']->outcome_name; } ?></div>

        <span class="request-column-title">How Received</span>
            <div class="request-column"><?php if(isset($GLOBALS['result']['request']->how_received_name)){ echo $GLOBALS['result']['request']->how_received_name; } ?></div>
             </div>
     ...
     <h5>Location Details</h5>
      ...
      <div class="column quarter">
        ...
        <div class="request-column"><?php if(isset($GLOBALS['result']['request']->customer_name_det->customer_name_details->telephone)){ echo $GLOBALS['result']['request']->customer_name_det->customer_name_details->telephone; } ?></div>
      </div>
<div class="column quarter">
      <span class="request-column-title">Mobile Number</span>
        <div class="request-column"><?php if(isset($GLOBALS['result']['request']->customer_name_det->customer_name_details->mobile_no)){ echo $GLOBALS['result']['request']->customer_name_det->customer_name_details->mobile_no; }?></div>
                  </div>
<div class="column quarter">
        <span class="request-column-title">Work Number</span>
        <div class="request-column"><?php if(isset($GLOBALS['result']['request']->customer_name_det->customer_name_details->work_phone)){ echo $GLOBALS['result']['request']->customer_name_det->customer_name_details->work_phone; }?></div>
