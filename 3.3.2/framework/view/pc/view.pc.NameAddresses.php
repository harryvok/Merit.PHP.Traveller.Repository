   ...
   <div class="margin-right">
        <div class="float-left">
          <div style="float:left;">
              ...
              <div style="float:left;">Addresses (<?php if(isset($GLOBALS['result']->address_details)){ echo count($GLOBALS['result']->address_details); } else{ echo 0; } ?>)</div>
          ...
          <div id="addresses"  class="dropdown">
				<input type="text" id="nameAddresses" class="tableSearch" placeholder="Search..." />
                  ...
                  <tr>
                      ...
                      <th class="job-id sortable">Full Addr No.</th>
                      ...
                      foreach($GLOBALS['result']->address_details as $result_a_ad){
                          ...
                          ?>
                              <tr class="<?php echo $class; ?>" onClick="change_add('<?php echo $change; ?>')" title="">
                                  <td id="<?php echo $change; ?>"><?php echo $result_a_ad->house_number; ?></td>
                                  <td><?php echo $result_a_ad->house_suffix; ?></td>
                  ...
                  elseif(isset($GLOBALS['result']->address_details) && count($GLOBALS['result']->address_details) == 1){
                      $change = $GLOBALS['result']->address_details->address_id;
                      ?>
                          <tr class="dark" onClick="change_add('<?php echo $change; ?>')" title="">
                              <td id="<?php echo $change; ?>"><?php echo $GLOBALS['result']->address_details->house_number; ?></td>
                              <td><?php echo $GLOBALS['result']->address_details->house_suffix; ?></td>
                              <td class="name"><?php echo $GLOBALS['result']->address_details->street_name; ?></td>
                              <td><?php echo $GLOBALS['result']->address_details->street_type; ?></td>
                              <td class="name"><?php echo $GLOBALS['result']->address_details->locality; ?></td>
                              <td><?php echo $GLOBALS['result']->address_details->postcode; ?></td>
                          </tr>
                          <?php
                  }
                  ?>
