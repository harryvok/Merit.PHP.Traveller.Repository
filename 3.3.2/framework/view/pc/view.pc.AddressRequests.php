                  ...
                  elseif(isset($GLOBALS['result']->request_details) && count($GLOBALS['result']->request_details) == 1){
                      ...
                      ?>
                          <tr class="dark" onClick="change('<?php echo $change; ?>')" title="">
                              ...
                              <td><?php if(isset($GLOBALS['result']->request_details->request_datetime) && strlen($GLOBALS['result']->request_details->request_datetime) > 0){ echo date('d/m/Y h:i A',strtotime(str_ireplace("T", " ", $GLOBALS['result']->request_details->request_datetime))); } else { echo "N"; } ?></td>
