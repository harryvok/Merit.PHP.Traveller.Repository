            ...
            if(isset($GLOBALS['result']->request_details) && count($GLOBALS['result']->request_details) > 1){
                ...
                foreach($GLOBALS['result']->request_details as $result_a_ar){
                    if(in_array($result_a_ar->request_id, $added_addresses_count) == false){
                        ...
                        array_push($added_addresses_count, $result_a_ar->request_id);
                        ?>
                        <ul class="pageitem searchObject"  id="searchObject<?php echo $count; ?>">
                            <li class="textbox">
                                <span class="header">
                                ...
                                <b>Completed Date:</b> <?php if(strlen($result_a_ar->status_datetime) > 0 && $result_a_ar->status_datetime != "1900-01-01T00:00:00" && $result_a_ar->status != "Open"){ echo date('d/m/Y h:i A',strtotime(str_ireplace("T", " ", $result_a_ar->status_datetime))); } ?>
                            </li>
                            <li class="menu">
