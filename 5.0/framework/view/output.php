...
$success_array = array(
    ...
    'success_action_resubmit' => 'The action with the action ID of #<a href="index.php?page=view-request&id='.$_SESSION['request_id'].'">'.$_SESSION['request_id'].'</a> has been resubmitted.',
