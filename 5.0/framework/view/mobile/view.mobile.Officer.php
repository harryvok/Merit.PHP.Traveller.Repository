...
<ul class="no-ellipses" data-role="listview" data-inset="true" data-divider-theme="b">
    ...
    <li><p><strong>Phone No: </strong> <?php if(isset($GLOBALS['result']->telephone)) echo $GLOBALS['result']->telephone; ?></p></li>
    <li><p><strong>Mobile No:</strong> <?php if(isset($GLOBALS['result']->mobile_no)) echo $GLOBALS['result']->mobile_no; ?></p></li>
    <li><p><strong>FAX No:</strong> <?php if(isset($GLOBALS['result']->fax_no)) echo $GLOBALS['result']->fax_no; ?></p></li>
    <li><p><strong>Email Address:</strong> <?php if(isset($GLOBALS['result']->mail_id)) echo $GLOBALS['result']->mail_id; ?></p></li>
</ul>
<ul class="no-ellipses" data-role="listview" data-inset="true" data-divider-theme="b">
