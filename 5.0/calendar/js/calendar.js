			...
			case 'string':
				if(source.length) {
					loader = function() {
						...
						//var myDate = new Date(1362938400000);
						//alert(myDate);
						...
						if (title.length > 0) {
						    ...
						    for (var i = 0; i < title.length; i++) {
						        var start_Date = new Date(start[i]);
						        var start_milli = start_Date.getTime();
						        var end_Date = new Date(end[i]);
						        var end_milli = end_Date.getTime();
						        json1 += '{' +
                                            '"id": "'+i+'",' +
                                            '"title": "'+title[i]+'",' +
                                            '"url": "'+url[i]+'",' +
