...
<select name="filter" id="filter" class="text" OnChange="getIntray('<?php if($_GET['page'] == "actions") echo "action"; elseif($_GET['page'] == "requests") echo $defaultpage; ?>',this.options[selectedIndex].value)">
    <?php
