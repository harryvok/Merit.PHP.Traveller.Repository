<?php        
if($GLOBALS['result']['action']->status_code == "OPEN" && $_SESSION['roleSecurity']->maint_comp_action == "Y"){ 
?>
...
<form id="completeaction" method="post" class="completeaction" action="process.php">
  ...
  <input type="hidden" name="assign_name" id="assign_name" value="<?php echo $GLOBALS['result']['action']->reason_assigned_name; ?>" />
</form>
<?php
}
?>
