           ...
           <label>Google Maps</label>
               <div id="map-canvas"></div>
                ...
                <label>Facility Type</label>
                      ...
                      <input name='lno' onChange="changeLocationType()"  id="lno" maxlength='15' value='<?php if(isset($_SESSION['rem_loc_address_fnumber'])){ echo $_SESSION['rem_loc_address_fnumber']; } ?>'>
          ...
          <p>
                      ...
                      <div id="outside_ca" style="display:none">
                         ...
                         <label>Type</label>
                          ...
                          <label>Description</label>
                          <input name='o_cdesc' id="o_cdesc" onChange="changeLocationType()" maxlength='1000' value='<?php if(isset($_SESSION['rem_cust_address_desc'])){ echo $_SESSION['rem_cust_address_desc']; } ?>'>
                      </div>
                  </ul>
              </p>
			</div>
