...
define("SITE_LINK", "http://traveller/4.0/");
define("WEBSITE", "http://traveller/4.0/"); // Traveller website address, with a slash on the end.
...
define("LOOKUP_ENABLED", ); // whether or not name and address lookup is enabled
