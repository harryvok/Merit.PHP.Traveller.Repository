...
?>
    ...
    <div class="column quarter">
        ...
        <div class="column quarter column-end">
            ...
            <div class="summaryColumn"><?php if($GLOBALS['result']->finalised_ind == "Y"){ if(isset($GLOBALS['result']->status_datetime) && strlen($GLOBALS['result']->status_datetime) > 0){ echo date('d/m/Y h:i A',strtotime(str_ireplace("00:00:00.000", "", $GLOBALS['result']->status_datetime))); } } ?></div>
            ...
            if($udf->udf_action_id == 0){
                ...
                if($udf->udf_type == "L"){
                    ...
                    $udf_ddld = array();
								...
								<div class="float-left">
									<select class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" name="udf_<?php echo $udf->udf_name; ?>" id="udf_<?php echo $udf->udf_order; ?>">
                ...
                elseif($udf->udf_type == "I"){
                    $i=$i+1;
							?>
								...
								<div class="float-left">
									<input type="text" name="udf_<?php echo $udf->udf_name; ?>" id="Text1" class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?> digits" value="<?php if(isset($udf->udf_data)) echo $udf->udf_data; ?>" size="5" maxlength="<?php if($udf->udf_fld_size > 0){ echo $udf->udf_fld_size; } ?>">
								</div>
							<?php
                }
                ...
                elseif($udf->udf_type == "D"){
                    $i=$i+1;
							?>
								...
								<div class="float-left">
									<input type="text" name="udf_<?php echo $udf->udf_name; ?>" id="Text4" class="dateField text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" value="<?php if(isset($udf->udf_data) && strlen($udf->udf_data) > 0) echo date("d/m/Y", strtotime(str_replace("/","-",$udf->udf_data))); ?>" size="5" maxlength="10"  >
								</div>
							<?php	
                }
                ...
                elseif($udf->udf_type == "M"){
                    $i=$i+1;
							?>
								...
								<div class="float-left">
									<input type="text" name="udf_<?php echo $udf->udf_name; ?>" id="Text5" class="timeField text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" value="<?php if(isset($udf->udf_data) && strlen($udf->udf_data) > 0) echo date("h:i A", strtotime($udf->udf_data)); ?>" size="5" maxlength="10">
								</div>
							<?php	
                }
                ...
                elseif($udf->udf_type == "G"){
                    $i=$i+1;
							  ?>
								  ...
								  <div class="float-left">
										<?php if(isset($udf->udf_data)){ if(stristr(str_ireplace("\\", "/", $udf->udf_data), ATTACHMENT_FOLDER)){ ?><a id="A2" class="ViewFile">View Attachment</a> <?php } else{ echo $udf->udf_data; } }  ?><br />
                ...
                elseif($udf->udf_type == "B"){
                    $i=$i+1;
							  ?>
								  ...
								  <div class="float-left">
										<?php if(isset($udf->udf_data)){ if(stristr(str_ireplace("\\", "/", $udf->udf_data), ATTACHMENT_FOLDER)){ ?><a id="A3" class="ViewFile">View Attachment</a> <?php } else{ echo $udf->udf_data; } }  ?><br />
                              ...
                              ?>
								  ...
								  <div class="float-left">
										<?php if(isset($udf->udf_data)){
                                                  if(stristr(str_ireplace("\\", "/", $udf->udf_data), ATTACHMENT_FOLDER)){ ?><a id="A4" class="ViewFile">View Attachment</a> <?php } else{ echo $udf->udf_data; }
                                              }  ?><br />
                ...
                if($udf->udf_type == "L"){
                    ...
                    $udf_ddld = array();
                        ?>
								...
								<div class="float-left">
									<select class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" name="udf_<?php echo $udf->udf_name; ?>" id="Select1">
									<option value="">Select</option>
										<?php
                    if(count($result2->udf_ddlb_det->string) > 1){
                        foreach($result2->udf_ddlb_det->string as $udf_ddld){
                ...
                elseif($udf->udf_type == "I"){
                    $i=$i+1;
							?>
								...
								<div class="float-left">
									<input type="text" name="udf_<?php echo $udf->udf_name; ?>" id="Text6" class="text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?> digits" value="<?php if(isset($udf->udf_data)) echo $udf->udf_data; ?>" size="5" maxlength="<?php if($udf->udf_fld_size > 0){ echo $udf->udf_fld_size; } ?>">
								</div>
							<?php
                }
                elseif($udf->udf_type == "A"){
                ...
                elseif($udf->udf_type == "D"){
                    $i=$i+1;
							?>
								...
								<div class="float-left">
									<input type="text" name="udf_<?php echo $udf->udf_name; ?>" id="Text9" class="dateField text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" value="<?php if(isset($udf->udf_data) && strlen($udf->udf_data) > 0) echo date("d/m/Y", strtotime(str_replace("/","-",$udf->udf_data))); ?>" size="5" maxlength="10"  >
								</div>
							<?php	
                }
                elseif($udf->udf_type == "Y"){
                    $i=$i+1;
							?>
								...
								<div class="float-left">
									<b>Yes</b> <input class="<?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" type="radio" name="udf_<?php echo $udf->udf_name; ?>" id="Radio1" <?php if(isset($udf->udf_data) && $udf->udf_data == 'Y'){ echo "checked"; } ?>  value="Y" /> <b>No</b> <input class="<?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" type="radio" <?php if(isset($udf->udf_data) && $udf->udf_data == 'N'){ echo "checked"; } ?> name="udf_<?php echo $udf->udf_name; ?>" id="Radio2"  value="N" /> 
								</div>
							<?php	
                }
                elseif($udf->udf_type == "M"){
                    $i=$i+1;
							?>
								...
								<div class="float-left">
									<input type="text" name="udf_<?php echo $udf->udf_name; ?>" id="Text10" class="timeField text-popup_udf <?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "required"; ?>" value="<?php if(isset($udf->udf_data) && strlen($udf->udf_data) > 0) echo date("h:i A", strtotime($udf->udf_data)); ?>" size="5" maxlength="10">
								</div>
							<?php	
                }
                elseif($udf->udf_type == "V"){
                ...
                elseif($udf->udf_type == "G"){
                    $i=$i+1;
							  ?>
								  ...
								  <div class="float-left">
										<?php if(isset($udf->udf_data)){ if(stristr(str_ireplace("\\", "/", $udf->udf_data), ATTACHMENT_FOLDER)){ ?><a id="A5" class="ViewFile">View Attachment</a> <?php } else{ echo $udf->udf_data; } }  ?><br />
                ...
                elseif($udf->udf_type == "B"){
                    $i=$i+1;
							  ?>
								  ...
								  <div class="float-left">
										<?php if(isset($udf->udf_data)){ if(stristr(str_ireplace("\\", "/", $udf->udf_data), ATTACHMENT_FOLDER)){ ?><a id="A6" class="ViewFile">View Attachment</a> <?php } else{ echo $udf->udf_data; } }  ?><br />
                ...
                elseif($udf->udf_type == "P"){
                    $i=$i+1;
							  ?>
								  ...
								  <div class="float-left">
										<?php if(isset($udf->udf_data)){ if(stristr(str_ireplace("\\", "/", $udf->udf_data), ATTACHMENT_FOLDER)){ ?><a id="A7" class="ViewFile">View Attachment</a> <?php } else{ echo $udf->udf_data; } }  ?><br />
...
<
  ...
  <input type="hidden" name="val-u" id="Hidden1" value="0" />
        <div style="float:left;">
                      <span class="summaryTableTitle"  style="float:left;">
                      <div style="float:left;">Action User Defined Fields (<?php echo $count_udf; ?>)</div>
      ...
      <table id="Table1" class=" sortable" title="" cellspacing="0">
                ...
                if($udf->udf_active_ind == "Y" && $udf->udf_action_id != 0){
                    ...
                    if($number == 2){
                        ...
                        <tr class="<?php echo $class; ?>_nocur">
                          ...
                          <?php if($udf->udf_type != "C" && $udf->udf_type != "E"){ ?><td><?php echo $udf->udf_name; ?><?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "<span style='color:red;'>*</span>"; ?></td><?php } ?>
                          <td <?php if($udf->udf_type == "C" || $udf->udf_type == "E"){ ?>colspan="2"<?php } ?>><?php if($udf->udf_type == "G" || $udf->udf_type == "B" || $udf->udf_type == "P"){ ?><?php if(isset($udf->udf_data)) {  if(stristr(str_ireplace("\\", "/", $udf->udf_data), ATTACHMENT_FOLDER)){ ?><a id="A8" class="ViewFile">View</a> <?php } } } elseif($udf->udf_type == "D"){ echo strlen($udf->udf_data) > 0 ? date("d/m/Y", strtotime(str_replace("/","-",$udf->udf_data))) : ""; } elseif($udf->udf_type == "V"){ echo strlen($udf->udf_data) > 0 ? date("d/m/Y h:i A", strtotime(str_replace("/", "-", $udf->udf_data))) : ""; } else{ echo $udf->udf_data; } ?></td>
                        </tr>
                        <?php  
                }
            }
        ...
        elseif(count($GLOBALS['result']['udfs']->udf_details) == 1){
            ...
            <tr class="light_nocur">
              ...
              <td><?php echo $udf->action_required;  ?></td>
              <?php if($udf->udf_type != "C" && $udf->udf_type != "E"){ ?><td><?php echo $udf->udf_name; ?><?php if(isset($udf->udf_mandatory_ind) && $udf->udf_mandatory_ind == "Y" || $udf->udf_mandatory_ind == "I")  echo "<span style='color:red;'>*</span>"; ?></td><?php } ?>
              <td <?php if($udf->udf_type == "C" || $udf->udf_type == "E"){ ?>colspan="2"<?php } ?>><?php if($udf->udf_type == "G" || $udf->udf_type == "B" || $udf->udf_type == "P"){ ?><?php if(isset($udf->udf_data)) {  if(stristr(str_ireplace("\\", "/", $udf->udf_data), ATTACHMENT_FOLDER)){ ?><a id="A9" class="ViewFile">View</a> <?php } } } elseif($udf->udf_type == "D"){ echo strlen($udf->udf_data) > 0 ? date("d/m/Y", strtotime(str_replace("/","-",$udf->udf_data))) : ""; } elseif($udf->udf_type == "V"){ echo strlen($udf->udf_data) > 0 ? date("d/m/Y h:i A", strtotime(str_replace("/", "-", $udf->udf_data))) : ""; } else{ echo $udf->udf_data; } ?></td>
            </tr>
            <?php
            }
        }
