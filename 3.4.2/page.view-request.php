...
if(isset($_SESSION['user_id'])){
    if(!isset($_SESSION['roleSecurity'])) $_SESSION['roleSecurity'] = $model->Get("RoleSecurity");
...
if(isset($_GET['d']) && $_GET['d'] == "udfs"){
    //currently using controller. This is to be removed and replaced with th display function below
...
//copied from page.view-action.php. currently only used for Request summary screen
